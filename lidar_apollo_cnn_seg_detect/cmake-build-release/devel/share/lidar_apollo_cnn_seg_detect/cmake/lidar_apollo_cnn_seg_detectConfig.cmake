...
if(NOT "/tmp/tmp.VUxo9KhYMh/include " STREQUAL " ")
  set(lidar_apollo_cnn_seg_detect_INCLUDE_DIRS "")
  set(_include_dirs "/tmp/tmp.VUxo9KhYMh/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar_apollo_cnn_seg_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/tmp/tmp.VUxo9KhYMh/${idir}'.  ${_report}")
    endif()
